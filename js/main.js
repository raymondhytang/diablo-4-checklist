var profilesKey = 'diablo4_profiles';
...
(function($) {
    ...
    function calculateTotals() {
        $('[id$="_overall_total"]').each(function(index) {
            ...
            $('[id^="' + type + '_totals_"]').each(function(index) {
                ...
                var regexFilter = new RegExp('^side_quests(.*)');
    ...
    $(function() {
        var jets = [new Jets({
            searchTag: '#side_quests_search',
            contentTag: '#side_quests_list h4, #side_quests_list ul'// This does not mean that we are searching inside the content of both <h4> and <ul> tags
        }), new Jets({
            searchTag: '#side_dungeons_search',
            contentTag: '#side_dungeons_search h4, #side_dungeons_list ul'// The outcome is that all <h4> tags are hidden while searching inside <ul> tags
        })];

        $('#side_quests_search').keyup(function() {
            $('#side_quests_list').unhighlight();
            $('#side_quests_list').highlight($(this).val());
        });
        ...
        $('#side_dungeons_search').keyup(function() {
            $('#side_dungeons_list').unhighlight();
            $('#side_dungeons_list').highlight($(this).val());
        });
    });
